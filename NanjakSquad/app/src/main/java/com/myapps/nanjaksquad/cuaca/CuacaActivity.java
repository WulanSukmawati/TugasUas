package com.myapps.nanjaksquad.cuaca;
...
import com.myapps.nanjaksquad.api.ApiService;
import com.myapps.nanjaksquad.model.ModelCuaca;
import com.myapps.nanjaksquad.R;
import com.myapps.nanjaksquad.model.ModelWaktu;
...
public class CuacaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.cuaca);
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(CuacaActivity.this);
        tvWaktu.setText(getDate.getDateNow("E, dd MMMM"));

        if(ActivityCompat.checkSelfPermission(CuacaActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(CuacaActivity.this
            ...
            ActivityCompat.requestPermissions(CuacaActivity.this
        ...
        if(locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER) ||
            ...
            fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                ...
                public void onComplete(@NonNull Task<Location> task) {
                    ...
                    if(location != null){
                        try {
                            Geocoder geocoder = new Geocoder(CuacaActivity.this, Locale.getDefault());
